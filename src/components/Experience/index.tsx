...
const experiences = [
  ...
  },
  {
    ...
    subtitle: "Power Pick",
    description:
      "Responsável pelo desenvolvimento do site principal da Power Pick, uma plataforma de compra de energia, comparando preços de diversos fornecedores. Trabalhei na criação de uma interface intuitiva para os usuários, permitindo a comparação fácil e rápida dos planos de energia disponíveis.",
  ...
  },
  {
    ...
    description:
      "Responsável pelo novo ecommerce da Nacional GO, assim como o novo site da empresa. Atuei com funcionalidades front-end e back-end do sistema interno da empresa. Desenvolvi um app mobile para motoristas em React Native, otimizando operações logísticas.",
  ...
  },
  {
    ...
    description:
      "Participei do desenvolvimento de uma aplicação mobile e web no setor energético, semelhante ao Méliuz, voltada para cashback e economia de energia elétrica. Atuei com foco em frontend e mobile, implementando telas responsivas e integração com APIs REST.",
  ...
  },
  {
    ...
    description:
      "Criação de um novo app mobile em React Native, substituindo tecnologias defasadas. Também atuei na reformulação completa do site principal com Next.js, com foco em performance, SEO e acessibilidade. Desenvolvi funcionalidades em tempo real utilizando WebSocket e SSE.",
    tags: ["Next.js", "React Native", "Kotlin", "WebSocket"],
  },
  {
    ...
    description:
      "Desenvolvimento de apps mobile focados em automação predial e IoT, com React Native e Expo. Os apps exibiam métricas em tempo real de sensores, controle de acesso e acionamento remoto.",
    tags: ["React Native", "Expo", "IoT"],
  },
  {
    icon: IoDesktopOutline,
    ...
    description:
      "Atuação em sistema de gestão industrial, com React Native no front e Java no backend. Desenvolvi dashboards e funcionalidades críticas para fábricas, além de realizar integrações com sensores e equipamentos industriais.",
    tags: ["React Native", "Java", "Spring Boot"],
  },
];
